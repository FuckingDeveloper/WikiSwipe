...
export const UI_COPY: Record<AppLanguage, UICopy> = {
  en: {
    ...
    homeSubtitle: "Read each random article first, then vote whether it was interesting.",
  ...
  ru: {
    ...
    homeSubtitle: "Сначала прочитайте случайную статью, потом голосуйте, было ли интересно.",
  ...
  de: {
    ...
    homeSubtitle: "Lies jeden Zufallsartikel zuerst und stimme dann ab, ob er interessant war.",
  ...
  fr: {
    ...
    homeSubtitle: "Lisez chaque article aléatoire, puis votez s'il était intéressant.",
  ...
  zh: {
    ...
    homeSubtitle: "先阅读随机词条，再投票判断它是否有意思。",
  ...
  es: {
    ...
    homeSubtitle: "Lee cada artículo aleatorio y luego vota si fue interesante.",
